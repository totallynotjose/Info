...
/**
 * Simplifies reading from {@link System#in} by providing dedicated methods for
 * reading each primitive data type (strings are treated as 'primitive' data as
 * well in this context). The behaviour of all methods is that the methods block
 * until the user enters valid data through {@link System#in}. In case of type
 * mismatches of the provided data the user will be requested for input
 * repeatedly until valid input data has been provided.
 *
...
public class SystemInReader {
	...
	/**
	 * Read a <code>String</code> object from standard input. The user input will be
	 * terminated by a line break (pressing ENTER-key). This method has been named
	 * in accordance with {@link java.io.PrintStream#println(String)}.
	 *
	 ...
	 * Read a <code>String</code> object from standard input. The user input will be
	 * terminated by a line break (pressing ENTER-key). This method has been named
	 * in accordance with other read-methods in this class and just maps to
	 * {@link #readln()}.
	 *
	 * @return The user's input as string
	 * @see #readln
	...
	/**
	 * Read <code>double</code> data from standard input. The user input will be
	 * terminated by a line break (pressing ENTER-key).
	 *
	...
	/**
	 * Read a single <code>char</code> from standard input. The user input will be
	 * terminated by a line break (pressing ENTER-key) but only single characters
